...
https://www.youtube.com/watch?v=vkueCwL2XX8&t=2s
...
- 전역함수
  ...
  **Output**
  ...
  | 파일 스트림 | ifstream<br />ofstream<br />fstream | ifstream - 파일에서 데이터를 읽을때 사용<br />ofstream - 파일에 데이터를 때 사용<br />fstream - 파일에서 데이터를 읽고 쓸 때 사용 |
