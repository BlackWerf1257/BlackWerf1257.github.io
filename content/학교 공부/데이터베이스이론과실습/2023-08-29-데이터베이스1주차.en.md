---
layout: post
title:  "Database Theory and Practice: Week 1"
tags: [23-2, DB]
---


# SQL (Structured Query Language)
A language used to manipulate data in a database <br/>
Reason for use: SQL allows you to build databases and extract and analyze the data within them <br/>
