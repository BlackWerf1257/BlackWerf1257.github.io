---
layout: post
title:  "グローバルオブジェクト指向プログラミング課題 - MySQLとC#の連携"
...
1. MySQLを使用してデータベースを構築する
2. C#を使用して、テーブルからデータを取得・更新する（SELECT、INSERT、UPDATE）コードを実装する
...
![画像の代替テキスト]({{link}}/assets/img/OOP/SQL/MySQL_Setup.png )

SQLは次のように構成した

<br/>

デフォルトでは、以下の2つの値のみを追加した

![画像の代替テキスト]({{link}}/assets/img/OOP/SQL/Default_Value.png )
