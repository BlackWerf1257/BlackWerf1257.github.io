---
layout: post
title:  "Global Object-Oriented Programming Assignment - Connecting MySQL and C#"
...
1. Build a database using MySQL
2. Implement code to retrieve and modify data from tables using C# (SELECT, INSERT, UPDATE)
...
![Image Alt text]({{link}}/assets/img/OOP/SQL/MySQL_Setup.png )

The SQL was structured as follows

<br/>

I only added the following two values as defaults

![Image Alt text]({{link}}/assets/img/OOP/SQL/Default_Value.png )
